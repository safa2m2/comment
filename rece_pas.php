            ...
            <form method="post">
              <div class="row">
                  ...
                  <ul class="media-list media-list-linked">
                    <li class="media"> <a href="#" class="media-link">
                      ...
                      <div class="media-body">
                        ...
                        <span class="text-muted"><?php echo $rows2['user_job']; ?></span> </div>
                ...
                <div style="text-align:center">
                  ...
                  <p>آیا می خواهید رمز عبور <span class="text-warning"><?php echo $rowsp['user_name']." ".$rowsp['user_family']; ?></span> را تغییر دهید ؟</p>
                </div>
                <?php }?>
